  ...
  return (
    <div className="content-page">
      ...
      <div className="docs-grid">
        <section className="page-section"><div className="section-heading"><span className="section-icon" aria-hidden="true">↟</span><div><span>Navigation</span><h2>Маршруты фермы</h2></div></div><ul className="docs-list"><li><Link to="/">Карта фермы</Link><span>здания, NPC-боты и Owner navigation</span></li><li><Link to="/bots/tb-001">Паспорт TB-001</Link><span>stages, gates и replay pipeline</span></li><li><Link to="/test-lab">Test Lab</Link><span>только local mock run</span></li><li><Link to="/risk">Risk Center</Link><span>NOT_EVALUATED + policy ladder</span></li></ul></section>
